...
#     # Let user choose the provider
#     st.session_state.llm_provider_selection = st.selectbox(
#         "Select LLM Provider:",
#         ["OpenAI (Cloud)", "Ollama (Local)"],
#         index=0 if st.session_state.llm_provider_selection == "OpenAI (Cloud)" else 1
#     )

#     # OpenAI Provider → show OpenAI API input
#     if st.session_state.llm_provider_selection == "OpenAI (Cloud)":
#         st.text_input(
...
#             placeholder="sk-...",
#         )
#         st.info("Using **OpenAI API** — Tavily API not required.", icon="💡")

#     # Ollama Provider → show Tavily API input
#     else:
#         st.text_input(
...
# # -------------------- Inject Tavily key dynamically --------------------
# def get_tavily_key():
#     """Returns correct Tavily key based on LLM provider."""
#     if st.session_state.llm_provider_selection == "OpenAI (Cloud)":
#         return st.secrets.get("TAVILY_API_KEY")  # optional fallback
#     else:
#         return st.session_state.get("tavily_api_key_input")

# # Safety check before chatbot init
# if st.session_state.llm_provider_selection == "Ollama (Local)" and not get_tavily_key():
...
#             self.tavily_client = TavilyClient(api_key=get_tavily_key())
...
import streamlit as st
import utils  # your updated utilsconfig.py
from tavily import TavilyClient
...
llm, tavily_client = utils.configure_llm_internet()
